...
class Config:
    ...
    ALIYUN_ACCESS_KEY_ID = os.getenv('ALIYUN_ACCESS_KEY_ID', '')  # 阿里云AccessKey ID（从环境变量读取）
    ALIYUN_ACCESS_KEY_SECRET = os.getenv('ALIYUN_ACCESS_KEY_SECRET', '')  # 阿里云AccessKey Secret（从环境变量读取）
    ...
    DEEPSEEK_API_KEY = os.getenv('DEEPSEEK_API_KEY', '')  # API密钥（从环境变量DEEPSEEK_API_KEY读取，或在此直接填写）
